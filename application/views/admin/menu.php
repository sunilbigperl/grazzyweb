...
<div class="btn-group pull-right">
	<a class="btn" href="<?php echo site_url($this->config->item('admin_folder').'/menus/form'); ?>"><i class="icon-plus-sign"></i> Add new menu</a>
</div>
	...
	<tbody>
		...
		$GLOBALS['admin_folder'] = $this->config->item('admin_folder');
			...
			<tr class="gc_row">
				...
				<td><a href="<?php echo site_url($this->config->item('admin_folder').'/menus/delete/'.$menu->menu_id.''); ?>">delete</a></td>
			</tr>
			<?php

		...
		?>
			<tr class="gc_row" id="<?=$pitstop->id;?>">
				...
				<?php if($pitstop->enabled == 0) { ?>
					...
					<a class="btn btn-danger btn-xs" data-toggle="modal" data-target="#DeactivateMenu" onclick="$('#pitid').val('<?=$pitstop->id;?>')">Deactivate</a>
...
<div class="modal-dialog">
  ...
  <div class="modal-content">
	<form action="<?php echo site_url($this->config->item('admin_folder').'/here/ChangeStatus'); ?>" method="post">

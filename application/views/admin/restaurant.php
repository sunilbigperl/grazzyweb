...
<!-- <a class="btn btn-primary" href="<?php echo site_url($this->config->item('admin_folder').'/restaurant/getmenulist');?>" style="margin-top:20px"><i class="icon-download"></i>Export Menu</a> -->
		...
		$GLOBALS['admin_folder'] = $this->config->item('admin_folder');
			...
			<tr class="gc_row">
				...
				<td>
			        ...
			        <?php $res_manager = $this->Restaurant_model->get_managers($restaurant->restaurant_manager); echo isset($res_manager[0]->firstname) ? $res_manager[0]->firstname : ''; ?>

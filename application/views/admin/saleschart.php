...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
<div id="chart_div" style="margin-top:40px;margin-left:-40px;"></div>
<script>
...
$.ajax({
  url:"<?php echo site_url($this->config->item('admin_folder').'/orders/data1'); ?>",
  dataType:"JSON",
  success:function(result){
     //alert(result);

  var array1=[];
  var fromdate = <?php echo  '"'. $fromdate1 . '"'; ?>;
  var todate = <?php echo  '"'. $todate1 . '"'; ?>;
  //  var current_date = new Date(result[0].day);
  //var current_date = new Date('2017-09-01');
  var current_date = new Date(fromdate);  

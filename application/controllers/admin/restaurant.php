...
class Restaurant extends Admin_Controller { 
    ...
    {  
	 ...
	 //$days1[]=$days;
        ...
        $objPHPExcel->getActiveSheet()->SetCellValue('V'.$rowCount,$excel['reimb']);
        $objPHPExcel->getActiveSheet()->SetCellValue('W'.$rowCount,$excel['preparation_time']); 

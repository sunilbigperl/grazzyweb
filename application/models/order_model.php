...
Class order_model extends CI_Model
{
	...
	function get_neworders(){
		...
		$sql = $this->db->query("SELECT a.*,d.order_type,d.ordertype_id,b.restaurant_name,b.preparation_time FROM `orders` a, restaurant b, order_type d, admin c,customers e WHERE  a.`restaurant_id` = b.restaurant_id  and a.`customer_id` = e.id  
